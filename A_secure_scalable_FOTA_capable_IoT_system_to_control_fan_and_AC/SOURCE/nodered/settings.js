...
module.exports = {
    ...
    adminAuth: {
	    ...
	    {
            	username: "admin",
            	password: "$2b$08$Fa.nScPyLN4mRVVFkLvd.e1ZKbqELUNmV5cJYZU0Np3mHJ1.Uw8nW",
            	permissions: "*"
            },
	    {
            	username: "user",
            	password: "$2b$08$XYb6.itW6FP9ikJ99EigeuWTdZ34WNlznnIVSuUvaYfWQPe3jtMuC",
            	permissions: "read"
            }
	]
    },
    ...
    httpNodeAuth: {user:"admin",pass:"$2b$08$BIxybGaTCkF/6/GLoW5RIeMt/9QPYuetE4ihDTHReG2QuM9eDGhce"},
    ...
    //// https object:
    https: {
      key: require("fs").readFileSync('/home/popchim/certs/raspberrypi.lan/privkey.pem'),
      cert: require("fs").readFileSync('/home/popchim/certs/raspberrypi.lan/cert.pem')
    },
    ////https function:
    // https: function() {
